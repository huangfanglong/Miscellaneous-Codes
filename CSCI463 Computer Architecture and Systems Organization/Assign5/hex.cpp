...
/**
* Returns a std::string beginning with 0x, followed by the 5 hex digits representing the 20 least significant bits of the i argument
* @param i 32bit hex value
* @return 32bit hex value as a string with '0x' in front
**/
...
/**
* Returns a std::string beginning with 0x, followed by the 3 hex digits representing the 12 least significant bits of the i argument
* @param i 32bit hex value
* @return 32bit hex value as a string with '0x' in front
**/
