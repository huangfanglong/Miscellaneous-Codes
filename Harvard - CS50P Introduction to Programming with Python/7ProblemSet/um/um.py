...
as an int, the number of times that “um” appears in that text, case-insensitively, as a word unto itself, not as a substring of some other word. 
...
def count(s):
    try:
        ...
        sys.exit("ValueError: Invalid input")
