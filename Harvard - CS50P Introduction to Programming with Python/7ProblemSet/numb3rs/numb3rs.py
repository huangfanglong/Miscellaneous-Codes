...
def validate(ip):
    pattern = r"^([01]?[0-9][0-9]?|2[0-4][0-9]|25[0-5]){1}\.([01]?[0-9][0-9]?|2[0-4][0-9]|25[0-5]){1}\.([01]?[0-9][0-9]?|2[0-4][0-9]|25[0-5]){1}\.([01]?[0-9][0-9]?|2[0-4][0-9]|25[0-5])$"
    # if match := re.search(r"^([01]?[0-9][0-9]?|2[0-4][0-9]|25[0-5]){1}\.([01]?[0-9][0-9]?|2[0-4][0-9]|25[0-5]){1}\.([01]?[0-9][0-9]?|2[0-4][0-9]|25[0-5]){1}\.([01]?[0-9][0-9]?|2[0-4][0-9]|25[0-5])$", ip):
